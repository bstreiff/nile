...
#       (https://systemd.io/FACTORY_RESET/), however:
# - We do have to deal with non-UEFI targets
#   (kula is not being built with UEFI... but maybe should?)
# - All the fun systemd factory-reset stuff is in version 258 and scarthgap is on 255 :(
#
# Our current proof-of-concept factory-reset implementation is as follows:
# - Mount the data partition
# - Check for the file data:/etc/factory-reset
#     - if present, unmount, then reformat the partition (this will remove /etc/factory-reset)
